        ...
        <div className="relative bg-[#1D3428] lg:min-h-screen text-white flex flex-col overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <div className="flex-1 flex flex-col lg:items-center lg:justify-center pt-32 lg:pt-36 pb-16 px-4 md:px-8">
                    ...
                    <motion.p
                        className="max-w-2xl text-center text-base md:text-lg text-white/80 leading-relaxed mb-10"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.1, duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
                    >
                        Discover three distinct culinary journeys crafted by our chefs—from vibrant Asian flavors to hearty Italian classics and fresh garden-inspired dishes. Choose your path below.
                    </motion.p>
                    <motion.div
                    ...
                    >
                        {buttons.map((btn, index) => (
                            <motion.div
                                ...
                                custom={index + 1}
                                variants={variants}
                                className="group relative w-full h-64 md:h-[50vh] overflow-hidden bg-black/20 transition-transform duration-500 ease-out hover:-translate-y-2"
                            >
                                <Image
                                    src={btn.image}
                                    alt={btn.title}
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center gap-5 px-6 text-center transition-transform duration-500 ease-out group-hover:-translate-y-1">
                                    ...
                                    <Link href={btn.href} className="flex justify-center">
                                        <span
